        ...
        "/friends": function() {
            $(".smalltext.button").click(function() {
                ...
                console.log(t), e.addClass("disabled"), api("friends/" + t, {
                    ...
                    e.removeClass("disabled"), e.data("deleted", t.friend ? "0" : "1"), e.removeClass("green red blue"), e.addClass(t.friend ? t.mutual ? "red" : "green" : "blue"), e.find(".icon").removeClass("minus plus heart").addClass(t.friend ? t.mutual ? "heart" : "minus" : "plus"), e.find("span").text(t.friend ? T(t.mutual ? "Mutual" : "Remove") : T("Mutual"))
                }, !0)
            })
        },
        "/followers": function() {
            $(".smalltext.button").click(function() {
                var e = $(this),
                    t = e.data("deleted") === undefined || e.data("deleted") === "1" ? "add" : "del";
                console.log(t), e.addClass("disabled"), api("friends/" + t, {
                    user: +e.data("userid")
                }, function(t) {
                    e.removeClass("disabled"), e.data("deleted", t.friend ? "0" : "1"), e.removeClass("green red blue"), e.addClass(t.friend ? t.mutual ? "red" : "green" : "blue"), e.find(".icon").removeClass("minus plus heart").addClass(t.friend ? t.mutual ? "heart" : "minus" : "plus"), e.find("span").text(t.friend ? T(t.mutual ? "Mutual" : "Remove") : T("Mutual"))
